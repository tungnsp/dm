              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                    Chúng tôi không chỉ là nơi để thưởng thức đặc sản ngon miệng, mà còn là không gian lý tưởng cho các buổi họp mặt, dịp kỷ niệm và những trải nghiệm ẩm thực độc đáo. 
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Đặt Hàng Ngay
          ...
          <div class="col-md-6  ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <a href="">
                  Đặt Ngay <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                    <g>
                      <g>
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <div class="heading_container">
              <h2>
                Chúng tôi là BTN FastFood
              </h2>
            </div>
            <p>
            Có rất nhiều biến thể của các đoạn Lorem Ipsum, nhưng phần lớn đã bị thay đổi
              dưới một số hình thức, bằng cách thêm vào sự hài hước hoặc những từ ngẫu nhiên trông không đáng tin chút nào. nếu bạn
              định sử dụng một đoạn văn của Lorem Ipsum, bạn cần chắc chắn rằng không có điều gì đáng xấu hổ ẩn giấu trong đó
              giữa văn bản. Tất cả
            </p>
            <a href="">
              Hơn Nữa
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="../../Dự_án_1/View/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
